! function(t) {
    ...
    let e = "kodik_player_duration_update",
        i = "kodik_player_time_update",
        o = "kodik_player_pause",
        A = "kodik_player_play",
        u = "analytics",
        a = "playerReady",
        c = "play",
    ...
    function B(t) {
        ...
        if (b = document.querySelector("#" + D), !b && (b = document.querySelector("#kin-x-online"), !b)) return !1;
        let q = document.createElement("div"),
            x = Array.prototype.slice.call(b.attributes);
        for (; r = x.pop();) q.setAttribute(r.nodeName, r.nodeValue);
        q.innerHTML = b.innerHTML, b.parentNode.replaceChild(q, b);
            ...
            function(t) {
                window.addEventListener("message", (function(r) {
                    ...
                    if (r.data.event) switch (r.data.event) {
                        case "initBtn":
                            t && j("Переключение плеєр", r.data.name);
                            break;
                        case u:
                            n = `Просмотр видео - ${d}`, I = r.data.name;
                            break;
                        case h:
                        case a:
                            n = `Просмотр видео - ${d}`, I = "init";
                            break;
                        case p:
                        case c:
                            n = `Просмотр видео - ${d}`, I = "start";
                            break;
                        case g:
                            n = `Просмотр видео - ${d}`, I = "init";
                            break;
                        case v:
                        case f:
                            n = `Просмотр видео - ${d}`, I = "pause";
                            break;
                        case l:
                        case s:
                            y = r.data.time, C = r.data.duration, M = Math.ceil(y / (C / 100)), w.includes(M) && M !== O && (O = M, n = `Просмотр видео - ${d}`, I = "View " + M + "% Video")
                    } else if (r.data.key) switch (r.data.key) {
                        case e:
                            C = r.data.value;
                            break;
                        case i:
                            y = r.data.value, M = Math.ceil(y / (C / 100)), w.includes(M) && M !== O && (O = M, n = `Просмотр видео - ${d}`, I = "View " + M + "% Video");
                            break;
                        case o:
                            n = `Просмотр видео - ${d}`, I = "pause";
                            break;
                    ...
                    n && I && (t && j(n, I), window.parent.postMessage({
                        event: "gaEvent",
                        category: n,
                        action: I
                    }, "*"))
        ...
        L = document.createElement("style"), L.type = "text/css", L.styleSheet ? L.styleSheet.cssText = W : L.appendChild(document.createTextNode(W)), F.appendChild(L), B = document.createElement("div"), B.setAttribute("id", "kin-x-loading"), q.innerHTML = "", q.appendChild(B), n = document.createElement("iframe"), n.setAttribute("id", "kin-x-iframe"), n.setAttribute("frameborder", "0"), n.setAttribute("allowfullscreen", "allowfullscreen"), q.appendChild(n), n.setAttribute("style", "border:none;position:absolute;top:0;left:0;width:100%;height:100%;"), n.setAttribute("width", "100%"), n.setAttribute("height", "100%"), q.setAttribute("style", "position:relative;width:100%;display:inline-block;overflow:hidden" + (parseInt(S.height) > 0 ? ";height:" + S.height + "px" : ""));
        ...
        U.setAttribute("id", "kin-x-padding"), U.setAttribute("style", "padding-top:56.25%;"), q.appendChild(U),
            function(t, r, n) {
                ...
                if (o > 0) {
                    for (let A = 0, u = e.length; A < u; A++) {
                        ...
                        if (t.hasOwnProperty(a) && t[a] && t[a].iframe) {
                            ...
                            if (c.onclick = function(t) {
                                    ...
                                    Q(encodeURIComponent(r.iframe), r.quality, r.translate, t, r["btn-size"], r.cdn)
                            ...
                            if (c.innerHTML += m[a], r && (Q(t[a].iframe, t[a].quality, t[a].translate, c, S["btn-size"], a, n), r = !1), n.appendChild(c), i && !(i % S["btn-limit"]) && e[A + 1]) {
                                let t = document.createElement("div");
                                t.onclick = function(t) {
                                    let r = document.querySelector('[data-event="' + (parseInt(t.target.dataset.j) + 1) + '"]');
                                    E(t.target.dataset.next), Q(encodeURIComponent(r.dataset.iframe), r.dataset.quality, r.dataset.translate, r, r.dataset["btn-size"], r.dataset.cdn)
                                ...
                                r.onclick = function(t) {
                                    ...
                                    E(t.target.dataset.prev), Q(encodeURIComponent(r.dataset.iframe), r.dataset.quality, r.dataset.translate, r, r.dataset["btn-size"], r.dataset.cdn)
                    ...
                    } else i > 1 && (q.appendChild(n), e.length > S["btn-limit"] && E(1))
    ...
    function Q(t, r, n, e, i, o, A) {
        e = e.target ? e.target : e, C = 0, y = 0, M = 0, O = 0, d = o, window.parent.postMessage({
            event: "initBtn",
            name: o,
            quality: r,
            translate: n
